...
import taxAnalyticsRoutes from "./routes/taxAnalytics.js";
...
app.use("/api/barbershops/:barbershopId/tax-analytics", protectAdmin, checkAccountStatus, taxAnalyticsRoutes);
